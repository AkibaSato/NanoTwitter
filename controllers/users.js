...
module.exports.follow = async (req, res) => {
  ...
  try {
    ...
    await axios.get(userServiceURL + '/follow', {
      data: {
...
module.exports.unfollow = async (req, res) => {
  ...
  try {
    ...
    await axios.get(userServiceURL + '/unfollow', {
      data: {
        followerId: followerId,
        followeeId: followeeId
      }
...
module.exports.getOriginalTweets = async (req, res) => {
  try {
    ...
    var [ userData, tweetsData ] = await Promise.all([ getUser, getTweet ]);
...
module.exports.getFolloweeTweets = async (req, res) => {
  ...
  try {
    ...
    var getTweets = axios.get(tweetServiceURL + '/timeline/followee', {
      data: { id: id }
    });
...
module.exports.getFollowees = async (req, res) => {
  try {
    ...
    var getTweets = axios.get(tweetServiceURL + '/followees', {
      data: { id: id }
    });
...
module.exports.getFollowers =  async (req, res) => {
  try {
    ...
    var getTweets = axios.get(tweetServiceURL + '/followers', {
      data: { id: id }
    });
